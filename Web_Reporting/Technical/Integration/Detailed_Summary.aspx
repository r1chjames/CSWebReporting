<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Detailed_Summary.aspx.cs" Inherits="Detailed_Summary" MasterPageFile="~/Site.Master"%>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>Detailed Integration Summary</h1>

        <div style="width: 100%; display: inline-block;">
        <h2>Valid OPM batches in Niche</h2>
        <asp:GridView ID="GridViewOPMBatchesDay" align="Center" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" onselectedindexchanged="GridView3_SelectedIndexChanged" AllowSorting="True" EnableViewState="False" ShowHeaderWhenEmpty="True" RowStyle-HorizontalAlign="Left" AlternatingRowStyle-BackColor="#e3f5d8" GridLines="None" CssClass="add_border">
            <Columns>
                <asp:BoundField DataField="Planned start" HeaderText="Planned start date" SortExpression="Planned start" ReadOnly="True" />
                <asp:BoundField DataField="Created" HeaderText="Created date" SortExpression="Created" ReadOnly="True" />
                <asp:BoundField DataField="Last updated" HeaderText="Last updated" ReadOnly="True" SortExpression="Last updated" />
...
<RowStyle HorizontalAlign="Left"></RowStyle>
        ...
        <br /><br />
          <div style="width: 100%; display: inline-block;">
             ...
             <asp:GridView ID="GridView6" align="Center" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" AllowSorting="True" RowStyle-HorizontalAlign="Left" AlternatingRowStyle-BackColor="#e3f5d8" GridLines="None" CssClass="add_border">
                 <Columns>
