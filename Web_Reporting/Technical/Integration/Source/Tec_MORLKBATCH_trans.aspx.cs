...
public partial class Tec_MORLKBATCH_trans : System.Web.UI.Page
{
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        cmd.Connection = conn;
        cmd.CommandText = "MORLKBATCH_export_Colne";
        ...
        context.Response.AddHeader("Content-Disposition", "attachment; filename=MORLKBATCH_Colne_" + DateTime.Now.ToShortDateString() + ".csv");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection("SERVER=WMM0772MANUAP01;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
        {
            ...
            {
                cmd.CommandText = "MORLKBATCH_trans";
                cmd.CommandType = CommandType.StoredProcedure;
