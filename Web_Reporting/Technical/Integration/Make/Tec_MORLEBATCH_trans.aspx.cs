...
using System.Data.SqlClient;
    ...
    public partial class MORLEBATCH_trans : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "MORLEBATCH_export_Colne";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=MORLEBATCH_Colne_" + DateTime.Now.ToShortDateString() + ".csv");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
                ...
                {
                    cmd.CommandText = "MORLEBATCH_trans";
                    cmd.CommandType = CommandType.StoredProcedure;
