<%@ Page Language="C#" AutoEventWireup="True" Inherits="MORLSENDQ_trans" MasterPageFile="~/Site.Master" Codebehind="MORLSENDQ_trans.aspx.cs" %>
...
<body>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
        ...
        <asp:Button ID="btnReconcileCToday" runat="server" Text="Reconcile (C) (Today)" onclick="btnReconcileCToday_Click" CausesValidation="false" class="download_button" />
        <asp:Button ID="btnReconcileCYday" runat="server" Text="Reconcile (C) (Yesterday)" onclick="btnReconcileCYday_Click" CausesValidation="false" class="download_button" />
        <asp:Button ID="btnReconcileSToday" runat="server" Text="Reconcile (S) (Today)" onclick="btnReconcileSToday_Click" CausesValidation="false" class="download_button" />
        <asp:Button ID="btnReconcileSYday" runat="server" Text="Reconcile (S) (Yesterday)" onclick="btnReconcileSYday_Click" CausesValidation="false" class="download_button" />
        <asp:Button ID="btnReconcileTToday" runat="server" Text="Reconcile (T) (Today)" onclick="btnReconcileTToday_Click" CausesValidation="false" class="download_button" />
        <asp:Button ID="btnReconcileTYday" runat="server" Text="Reconcile (T) (Yesterday)" onclick="btnReconcileTYday_Click" CausesValidation="false" class="download_button" />
        </asp:Panel>
