...
public partial class MORLSENDQ_itemreconciliation : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
                ...
                {
                    cmd.CommandText = "MORLSENDQ_ItemReconciliation";
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=MORLSENDQ_Colne_ItemRec_" + DateTime.Now.ToShortDateString() + ".csv");
