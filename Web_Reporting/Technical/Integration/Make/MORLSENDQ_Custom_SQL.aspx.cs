...
using System.Data.SqlClient;
    ...
    public partial class MORLSENDQ_Custom_SQL : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "MORLSENDQ_Custom_SQL";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@var_site", RadioButtonListSite.SelectedValue);
            cmd.Parameters.AddWithValue("@var_where", txtWhere.Text);
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=MORLSENDQ_Custom_SQL_" + DateTime.Now.ToShortDateString() + ".csv");
