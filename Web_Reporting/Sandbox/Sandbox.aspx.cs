...
using System.Web.Security;
    ...
    public partial class SANDBOX : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("MORLSENDQ_trans_Colne.aspx");
        }
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "MORLSENDQ_export_Colne";
        ...
        protected void btnReconcileToday_Click(object sender, EventArgs e)
        {
        ...
        protected void btnReconcileYday_Click(object sender, EventArgs e)
        {
        ...
        using (SqlConnection con = new SqlConnection("SERVER=WMM0772MANUAP01;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
        {
            ...
            {
                cmd.CommandText = "SB_MORLSENDQ_trans_date";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@var_date1", TextBox1.Text);
                cmd.Parameters.AddWithValue("@var_date2", TextBox2.Text);
                cmd.Connection = con;
        ...
        //GridViewColneMORLSENDQ.DataSource = ds;
        GridViewColneMORLSENDQ.DataBind();
