...
public partial class Bus_MORLKBATCH_trans : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
                ...
                {
                    cmd.CommandText = "Bus_MORLKBATCH_trans";
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=MORLKBATCH_" + DateTime.Now.ToShortDateString() + ".csv");
        ...
        protected void GridViewColneMORLKBATCH_rowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.Cells[8].Text.ToString() != "Processed and Ready to be Sequenced")
                {
