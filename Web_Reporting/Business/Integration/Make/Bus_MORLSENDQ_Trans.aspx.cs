...
using System.Data.SqlClient;
    ...
    public partial class Bus_MORLSENDQ_Trans : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
                ...
                {
                    cmd.CommandText = "Bus_MORLSENDQ_trans";
                    ...
                    cmd.Parameters.AddWithValue("@var_trans_status", RadioButtonListTransStatus.SelectedValue);
                    cmd.Connection = con;
