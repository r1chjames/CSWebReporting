...
using System.Data.SqlClient;
    ...
    public partial class MORLSENDQ_Volumes : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
                ...
                {
                    cmd.CommandText = "Bus_Rep_MORLSENDQ_Count";
                    ...
                    cmd.Parameters.AddWithValue("@var_time1", txtFromTime.Text);
                    cmd.Parameters.AddWithValue("@var_time2", txtToTime.Text);
                    cmd.Parameters.AddWithValue("@var_trans_type", RadioButtonTransType.SelectedValue);
                    cmd.Parameters.AddWithValue("@var_species", RadioButtonSpecies.SelectedValue);
                    cmd.Parameters.AddWithValue("@var_prod_stage", DropDownProdStage.SelectedValue);
                    cmd.Connection = con;
