...
using System.Web.Security;
    ...
    public partial class Cattle_carcass_details : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "BAU_Cattle_Carcass_Report";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Cattle_Carcass_Details_" + DateTime.Now.ToShortDateString() + ".csv");
