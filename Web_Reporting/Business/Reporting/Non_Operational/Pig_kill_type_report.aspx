<%@ Page Language="C#" AutoEventWireup="True" Inherits="Pig_kill_type_report" MasterPageFile="~/Site.Master" Codebehind="Pig_kill_type_report.aspx.cs" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowSorting="True" RowStyle-HorizontalAlign="Left" AlternatingRowStyle-BackColor="#e3f5d8" GridLines="None" CssClass="add_border">
            <Columns>
                <asp:BoundField DataField="Kill Date" HeaderText="Kill date" SortExpression="Kill Date" />
                <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
                <asp:BoundField DataField="Number Killed" HeaderText="Number killed" SortExpression="Number Killed" />
            </Columns>
            <EmptyDataTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="Bus_Kill_By_Type" 
