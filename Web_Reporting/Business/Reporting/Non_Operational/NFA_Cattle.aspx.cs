...
public partial class NFA_Cattle : System.Web.UI.Page
{
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        cmd.Connection = conn;
        cmd.CommandText = "Bus_NFA_Cattle";
        ...
        context.Response.AddHeader("Content-Disposition", "attachment; filename=NFA_Cattle_" + DateTime.Now.ToShortDateString() + ".csv");
