...
public partial class Carcass_Weights : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_Carcass_Weight";
            ...
            cmd.Parameters.AddWithValue("@var_species", RadioButtonListSpecies.SelectedValue);
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Carcass_Weights_" + DateTime.Now.ToShortDateString() + ".csv");
