<%@ Page Language="C#" AutoEventWireup="True" Inherits="Cattle_carcass_details" MasterPageFile="~/Site.Master" Codebehind="Cattle_carcass_details.aspx.cs" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager" runat="server">
        ...
        <asp:GridView ID="GridViewBreeds" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowSorting="True" RowStyle-HorizontalAlign="Left" AlternatingRowStyle-BackColor="#e3f5d8" GridLines="None" CssClass="add_border">
            <Columns>
                ...
                <asp:BoundField DataField="Kill Number" HeaderText="Kill Number" SortExpression="Kill Number" />
                <asp:BoundField DataField="Origin" HeaderText="Origin" SortExpression="Origin" />
                <asp:BoundField DataField="OTM/UTM" HeaderText="OTM/UTM" ReadOnly="True" SortExpression="OTM/UTM" />
                <asp:BoundField DataField="Weight (KG)" HeaderText="Weight (KG)" SortExpression="Weight (KG)" />
                <asp:BoundField DataField="Grade" HeaderText="Grade" SortExpression="Grade" />
                <asp:BoundField DataField="Month and Year" HeaderText="Month and Year" SortExpression="Month and Year" />
            </Columns>
            <EmptyDataTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="BAU_Cattle_Carcass_Report" 
