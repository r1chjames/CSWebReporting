...
using System.Data.SqlClient;
    ...
    public partial class Beef_boning_report : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_BeefBoningReport";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@var_site", RadioButtonListSite.SelectedValue);
            cmd.Parameters.AddWithValue("@var_extbat", txtExtNum.Text);
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Cattle_Boning_Report_" + DateTime.Now.ToShortDateString() + ".csv");
