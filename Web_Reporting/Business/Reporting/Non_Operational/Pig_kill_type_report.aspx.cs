...
using System.Web.Security;
    ...
    public partial class Pig_kill_type_report : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Kill_By_Type";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Pig_Kill_Type_Report_" + DateTime.Now.ToShortDateString() + ".csv");
