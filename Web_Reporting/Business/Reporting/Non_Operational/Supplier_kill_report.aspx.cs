...
public partial class Supplier_kill_report : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_SupplierKill";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Cattle_Supplier_Kills_" + DateTime.Now.ToShortDateString() + ".csv");
