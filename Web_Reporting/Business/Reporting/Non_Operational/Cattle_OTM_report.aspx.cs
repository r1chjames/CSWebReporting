...
using System.Web.Security;
    ...
    public partial class Cattle_OTM_report : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Cattle_OTM_" + DateTime.Now.ToShortDateString() + ".csv");
