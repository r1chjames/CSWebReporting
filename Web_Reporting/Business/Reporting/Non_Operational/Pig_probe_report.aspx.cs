...
using System.Data.SqlClient;
    ...
    public partial class Pig_probe_report : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_Pig_Probe";
            ...
            cmd.Parameters.AddWithValue("@var_probe1", txtFromProbe.Text);
            cmd.Parameters.AddWithValue("@var_probe2", txtToProbe.Text);
            cmd.Parameters.AddWithValue("@var_origin", txtOrigin.Text);
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Pig_Probe_Report_" + DateTime.Now.ToShortDateString() + ".csv");
