...
using System.Web.Security;
    ...
    public partial class Colne_RFID_Scan_Detail : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_Colne_RFID_Scan_Detail";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Colne_RFID_Scan_Detail_" + DateTime.Now.ToShortDateString() + ".csv");
