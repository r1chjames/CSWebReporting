...
using System.Data.SqlClient;
    ...
    public partial class ARAMS_Reader_Detail : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_ARAMS_Batches";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=ARAMS_Batches_" + DateTime.Now.ToShortDateString() + ".csv");
        ...
        protected void btnDownload2_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_ARAMS_Readings";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@var_date1", txtFromDate.Text);
            ad = new SqlDataAdapter(cmd);
            ad.Fill(tempData = new DataTable());
            ...
            context.Response.Clear();
            context.Response.ContentType = "text/csv";
            context.Response.AddHeader("Content-Disposition", "attachment; filename=ARAMS_Readings_" + DateTime.Now.ToShortDateString() + ".csv");
        ...
        protected void btnDownload3_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_ARAMS_Flocks";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@var_date1", txtFromDate.Text);
            ad = new SqlDataAdapter(cmd);
            ad.Fill(tempData = new DataTable());
            ...
            context.Response.Clear();
            context.Response.ContentType = "text/csv";
            context.Response.AddHeader("Content-Disposition", "attachment; filename=ARAMS_Flocks_" + DateTime.Now.ToShortDateString() + ".csv");
        ...
        protected void init_GridView2(object sender, EventArgs e)
        {
            DataSet ds = new DataSet();
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
        ...
        protected void init_GridView3(object sender, EventArgs e)
        {
            DataSet ds = new DataSet();
            using (SqlConnection con = new SqlConnection("SERVER=WS-ES12R2;Trusted_Connection=Yes;DATABASE=Web_Reporting"))
            {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            init_GridView2(null, null); 
            init_GridView3(null, null); 
        }
