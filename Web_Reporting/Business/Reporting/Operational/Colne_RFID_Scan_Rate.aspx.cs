...
using System.Data.SqlClient;
    ...
    public partial class Colne_RFID_Scan_Rate : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_Colne_RFID_Scan_Rate";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Colne_RFID_Scan_Rate_" + DateTime.Now.ToShortDateString() + ".csv");
