...
using System.Data.SqlClient;
    ...
    public partial class Bizerba_OCM_Numerators : System.Web.UI.Page
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "Bus_Rep_Bizerba_Numerators";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment; filename=Bizerba_OCM_Numerators_" + DateTime.Now.ToShortDateString() + ".csv");
